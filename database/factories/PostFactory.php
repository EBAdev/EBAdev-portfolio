...
class PostFactory extends Factory
{
    ...
    public function definition()
    {
      ...
      $body ='<p class="lead">Until now, trying to style an article, document, or blog post with Tailwind has been a tedious task that required a keen eye for typography and a lot of complex custom CSS.</p>
  ...
  plugins: [],
      ...
      <p>What I\'ve written here is probably long enough, but adding this final sentence can\'t hurt.</p>';
        ...
        return [
          ...
          'excerpt' => $this->faker->paragraph($nbSentences = 5),
          'body' => $body,
          'published_at' => now(),
        ];
    }
